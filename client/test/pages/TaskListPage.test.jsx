...
describe('TaskListPage', () => {
  it('allows navigation to task creation and a selected task', async () => {
    ...
    render(<TaskListPage tasks={[{ id: '3', title: 'Testing', status: 'draft', evidence_count: 0 }]} loading={false} error="" onBack={vi.fn()} onCreateTask={onCreateTask} onSelectTask={onSelectTask} />)
